...
public class Intermediario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewPergunta = findViewById(R.id.textViewPerguntaI);
        TXTpnd= findViewById(R.id.TXTpndI);
        radioGroupRespostas = findViewById(R.id.radioGroupRespostasI);
        buttonProximaPergunta = findViewById(R.id.buttonProximaPerguntaI);
        Acertos = findViewById(R.id.AcertosI);
        TextsobB = findViewById(R.id.TextsobBI);
        ...
        Button btnVoltarParaMain = findViewById(R.id.btnVoltarParaMainI);
        btnVoltarParaMain.setOnClickListener(v -> {
            Intent intent = new Intent(Intermediario.this, MainActivity.class);
