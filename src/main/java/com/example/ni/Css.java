...
public class Css extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewPergunta = findViewById(R.id.textViewPerguntac);
        TXTpnd= findViewById(R.id.TXTpndc);
        radioGroupRespostas = findViewById(R.id.radioGroupRespostasc);
        buttonProximaPergunta = findViewById(R.id.buttonProximaPerguntac);
        Acertos = findViewById(R.id.Acertosc);
        TextsobB = findViewById(R.id.Textsobc);
        ...
        Button btnVoltarParaMain = findViewById(R.id.btnVoltarParaMainc);
        btnVoltarParaMain.setOnClickListener(v -> {
            Intent intent = new Intent(Css.this, MainActivity.class);
    ...
    private void fetchPerguntasFromServer() {
        ...
        String url = "https://fxxsfw-3001.csb.app/selecao-conteudo-1";
