...
public class Avancadotxt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_avancadotxt);
        tituloTextView = findViewById(R.id.tituloTextViewA);
        textoTextView = findViewById(R.id.textoTextViewA);
        exemploTextView = findViewById(R.id.exemploTextViewA);
        changeContentBtn = findViewById(R.id.changeContentButtonA);
        BtnPerguntas = findViewById(R.id.BtnPerguntasA);
        ...
        BtnPerguntas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Avancadotxt.this, Avancado.class);
